...
/* harmony export */ });
/* unused harmony exports log, unique, strcmp, sort_keys, vercmp, zip_object, map_keys, get_key_mapper, map_values, filter_keys, filter_values, pick, omit, concat, encode, buffer_equals, poll, fuzzyfilter, get, global_get, invoke, delta2str, datetime_format, date_format, time_format, Timer, grep, lowercase_first_letter, throttle, debounce, tomorrow, to_csv_field, array_equals */
/* harmony import */ var _prototype_common_ts__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./prototype.common.ts */ 6544);
/* harmony import */ var _platform_common_ts__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./platform.common.ts */ 9079);
...
/* harmony import */ var _prototype_browser_ts__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./prototype.browser.ts */ 4089);
/* harmony import */ var _platform_browser_ts__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./platform.browser.ts */ 5044);
/* harmony import */ var _utils_common_ts__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./utils.common.ts */ 377);
...
/* harmony import */ var _platform_browser_ts__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./platform.browser.ts */ 5044);
/* harmony import */ var _prototype_common_ts__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./prototype.common.ts */ 6544);
...
/* harmony import */ var _utils_browser_ts__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./utils.browser.ts */ 2994);
/* harmony import */ var _net_common_ts__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./net.common.ts */ 9319);
...
/* harmony export */ });
/* harmony import */ var _prototype_common_ts__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./prototype.common.ts */ 6544);
/* harmony import */ var _utils_common_ts__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utils.common.ts */ 377);
...
/* harmony import */ var _platform_common_ts__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./platform.common.ts */ 9079);
/* harmony import */ var _prototype_common_ts__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./prototype.common.ts */ 6544);
/* harmony import */ var _utils_common_ts__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./utils.common.ts */ 377);
...
/* harmony import */ var _lib_net_browser_ts__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @lib/net.browser.ts */ 4100);

const shfcom = 'shenhongfei.com';
const url6 = `https://${shfcom}:9443`;
async function get_public_port() {
    return (await (0,_lib_net_browser_ts__WEBPACK_IMPORTED_MODULE_0__/* .request_json */ .bL)('https://ngqltslh.lc-cn-n1-shared.com/1.1/classes/ports/6905d33b1c203d5a4110d509', {
        headers: {
...
async function select_url() {
    ...
    try {
        return `https://4.${shfcom}:${await get_public_port()}`;
    }
    catch (error) {
        console.error(error);
        return url6;
...
/* harmony import */ var _platform_common_ts__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./platform.common.ts */ 9079);
/* harmony import */ var _prototype_common_ts__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./prototype.common.ts */ 6544);
/* harmony import */ var _io_common_ts__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./io.common.ts */ 4854);
/* harmony import */ var _utils_common_ts__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./utils.common.ts */ 377);
    ...
    constructor(url, protocols, event, message) {
        ...
        if (!message)
            if (event)
                ...
                message = '连接被关闭';
        super((0,_utils_common_ts__WEBPACK_IMPORTED_MODULE_3__/* .nowstr */ .WF)() + '  ' +
            (url || '传入') +
...
proxy, on_message, on_error, on_close, connect }) {
    ...
    let pwebsocket = (0,_utils_common_ts__WEBPACK_IMPORTED_MODULE_3__/* .defer2 */ .LQ)();
...
/******/ var __webpack_exports__ = __webpack_require__(6358);
